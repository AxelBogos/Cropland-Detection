...
def load_data(scaler: str = "standard") -> tuple:
...
def run_single_experiment(
    clf, model_name, scaler: str = None, use_comet: bool = False, do_save_preds=True
):
    ...
    Args:
        ...
        scaler (str, optional): Type of scaler to be used when loading data. See 'load_data()'. Defaults to None.
